...
- 📦 **最新版下载**：请前往右侧 [Releases](../../releases) 页面获取最新版可执行程序（`d2mxlutils_plus.exe`）。
- 📝 **更新日志**：详见下方或查阅 [CHANGELOG.md](./CHANGELOG.md)。
...
- Feat(radar): 小地图自定义标记怪物支持显示名称/短别名与显隐控制 (651e0b4)

### Miscellaneous

- Chore(release): 升级版本至 v1.28.22 (adb87e5)
...
- Chore(release): 升级版本至 v1.28.21 (59103c3)
...
- Feat(radar): 小地图怪物雷达支持根据怪物ID自定义标记颜色与形状 (af9d8c6)

### Miscellaneous

- Chore(release): 升级版本至 v1.28.20 (e0ffe81)

## v1.28.19 — 2026-09-23

### CI

- Ci: 注释并停用 Linux 构建任务，仅保留 Windows 版本发布 (d315d98)

### Features

- Feat: 主窗口左下角添加[免费使用请勿受骗]声明，升级版本至 v1.28.19 (beb8ea4)
